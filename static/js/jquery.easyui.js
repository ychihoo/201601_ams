            ...
            if (_5c) {
                ...
                _5c = $.data(this, "combobox", {
                    options: $.extend({}, $.fn.combobox.defaults, {
                        ...
                        url: t.attr("url")
                    }, _5a), combobox: r.combobox, content: r.content
                });
                _49(this, _44(this));
            }
            ...
            if (_84) {
                ...
                _84 = $.data(this, "combotree", {
                    options: $.extend({}, $.fn.combotree.defaults, {
                        ...
                        url: $(this).attr("url")
                    }, _82), combotree: r.combotree, content: r.content
                });
            }
            _60(this);
        });
...
(function ($) {
    ...
    function _90(_91, _92) {
        ...
        $(_91).attr({
            ...
            cellpadding: 0,
            border: 0
        }).removeAttr("width").removeAttr("height").appendTo($(".datagrid-view2 .datagrid-body", _93));
        function _95(_97) {
            var _98 = [];
    ...
    function _119(_11a) {
        ...
        $(_11a).window($.extend({}, opts, {
            onResize: function (_11f, _120) {
                ...
                _11b.panel("resize", {
                    width: _121.width(),
                    height: (_120 == "auto") ? "auto" : _121.height() - _121.find(">div.dialog-toolbar").outerHeight() - _121.find(">div.dialog-button").outerHeight()
                });
                if (opts.onResize) {
        ...
        if (_15e.east.length) {
            ...
            _15e.east.panel("header").find(".layout-button-right").click(function () {
                ...
                _15e.east.panel("panel").animate({left: cc.width()}, function () {
                    ...
                    _15e.expandEast.panel("open").panel("resize", {
                        top: _15e.east.panel("options").top,
                        left: cc.width() - 28,
                        width: 28,
                        height: _15e.east.panel("options").height
                    });
                });
                if (!_15e.expandEast) {
        ...
        if (_15e.west.length) {
            ...
            _15e.west.panel("header").find(".layout-button-left").click(function () {
                ...
                _15e.center.panel("resize", {
                    width: _15e.center.panel("options").width + _15e.west.panel("options").width - 32,
                    left: 32
                });
        ...
        if (_15e.south.length) {
            ...
            _15e.south.panel("header").find(".layout-button-down").click(function () {
                ...
                _15e.south.panel("panel").animate({top: cc.height()}, function () {
                    ...
                    _15e.expandSouth.panel("open").panel("resize", {
                        top: cc.height() - 28,
                        left: 0,
                        width: cc.width(),
                        height: 28
        ...
        return this.each(function () {
            ...
            if (_27f) {
                ...
                _27f = $.data(this, "validatebox", {
                    ...
                    }, _27e), validatebox: r.validatebox, tip: r.tip
                });
            }
            _274(this);
        });
        ...
        _299.window.draggable({
            ...
            onStartDrag: function (e) {
                ...
                _299.proxy.css({
                    ...
                    left: e.data.left,
                    top: e.data.top,
                    width: ($.boxModel == true ? (_299.window.outerWidth() - (_299.proxy.outerWidth() - _299.proxy.width())) : _299.window.outerWidth()),
                    height: ($.boxModel == true ? (_299.window.outerHeight() - (_299.proxy.outerHeight() - _299.proxy.height())) : _299.window.outerHeight())
                });
                setTimeout(function () {
                    _299.proxy.show();
                }, 500);
        ...
        _299.window.resizable({
            disabled: _299.options.resizable == false, onStartResize: function (e) {
                ...
                _299.proxy.css({
                    ...
                    left: e.data.left,
                    top: e.data.top,
                    width: ($.boxModel == true ? (e.data.width - (_299.proxy.outerWidth() - _299.proxy.width())) : e.data.width),
                    height: ($.boxModel == true ? (e.data.height - (_299.proxy.outerHeight() - _299.proxy.height())) : e.data.height)
                });
            }, onResize: function (e) {
                _299.proxy.css({
                    left: e.data.left,
